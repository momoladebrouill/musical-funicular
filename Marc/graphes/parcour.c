#define MAXV 10 /* nombre maximum de sommets */
#include <stdlib.h>
#include <stdbool.h>
#include <stdio.h>
...
//TODO keep track of the road and make it work finally
void djikstra(graph *g, int dst, int src){
    queue * s = malloc(sizeof(queue));
    init_queue(s);
    init_search(g);
    enqueue(s,src);
